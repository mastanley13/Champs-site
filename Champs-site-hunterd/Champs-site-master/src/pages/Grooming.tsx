    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12">
          <div className="max-w-4xl md:ml-[-100px]">
            <h1 className="hero-heading text-6xl md:text-7xl lg:text-8xl mb-6 text-white leading-tight">
              Pet
              <br />
              <span className="text-[#E63946] block mt-2">Grooming</span>
            </h1>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-anton text-4xl text-center mb-16 text-[#003B6D] uppercase tracking-wide drop-shadow-sm">
      ...
      <section id="services" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="font-anton text-4xl text-center mb-16 text-[#003B6D] uppercase tracking-wide drop-shadow-sm">Our Grooming Services</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-anton text-4xl text-center mb-12 text-[#003B6D] uppercase tracking-wide drop-shadow-sm">What to Expect</h2>
      ...
      <section className="py-24 bg-[#005596] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-anton text-4xl mb-8 text-white uppercase tracking-wide drop-shadow-sm">Ready to Book Your Dog's Spa Day?</h2>
