...
export function DaycarePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Train & Play Opportunities",
      description: "Looking to improve your dogs behavior while they play. We offer 1:1 engagement sessions."
    }
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12">
          <div className="max-w-4xl md:ml-[-100px]">
            ...
            <h2 className="font-anton text-2xl md:text-3xl lg:text-4xl text-white mb-6 tracking-wide">
              WHERE <span className="text-[#E63946]">CHAMPION</span> DOGS SPEND THEIR DAY - THE <span className="text-[#E63946]">CHAMPION</span> WAY
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-12 max-w-2xl leading-relaxed">
              We provide a safe, engaging environment where your dog can play, socialize, and stay active.
            </p>
